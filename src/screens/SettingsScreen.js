...
function SettingsScreen() {
  return (
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      <StatusBar translucent barStyle="dark-content" backgroundColor="#ccc" />
      ...
      <View style={{ flex: 1.5, alignItems: 'center', paddingVertical: 20, }}>
      ...
      <View style={{ flex: 0.6, flexDirection: 'row', alignSelf: 'center', paddingTop: 20, }}>
        <View style={{ flex: 0.6 }}>
